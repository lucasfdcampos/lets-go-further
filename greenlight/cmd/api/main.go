...
import (
	...
	"greenlight.lucasfdcampos.net/internal/jsonlog"
...
type config struct {
	...
	// Add a new limiter struct containing the fields for the requests-per-second and burst
...
func main() {
	...
	// Notice that we use true default for the 'enabled' setting?
